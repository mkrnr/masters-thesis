...
%TODO continue adding Michaels remarks\dots.
...
The following demonstration is based on the calculation of $P(\mathbf{X})$ for \glspl{hmm} using the \gls{forward-backward algorithm} in \citet{sutton2010introduction}.

\bigskip

By applying the distributive law we can reorder \Cref{equ:linear-chain-crf-z} the following way:
\begin{equation}
  \begin{split}
