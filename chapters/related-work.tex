...
We will also survey \gls{distant supervision} as a method for generating training data of labeled reference strings.\\
...
In their use case of relation extraction, \citet{mintz2009distant} use the semantic database \emph{Freebase} \citep{bollacker2008freebase} for the \gls{distant supervision}.
The assumption is that if a sentence contains a pair of entities that are part of a Freebase relation, it is likely to express that relation in some way \citep{mintz2009distant}.
