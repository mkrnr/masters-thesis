...
Thereby, \citet{tsuboi2008training} propose a method of training \glspl{crf} using incomplete annotations.
...
We will discuss \gls{ge} criteria in more detail in \todo{add}.

\bigskip


%TODO \citet{lu2013web} distant supervision and GE on name entity recognition
