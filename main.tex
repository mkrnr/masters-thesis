...
pdfstartpage=1,
pdftitle={Author Extraction from Social Science Research Papers Using Conditional Random Fields and Distant Supervision},
pdfauthor={Martin K\"{o}rner},
pdfsubject={Master's Thesis},
pdfkeywords={CRFs,distant supervision,author extraction,entity recognition,probabilistic graphical models, generalized expectation},
breaklinks=true,
colorlinks=true,
linkcolor=black,
anchorcolor=black,
...
\printglossary[type=\acronymtype,title={List of Abbreviations},nonumberlist,nogroupskip]
\cleardoublepage{}
